...
<html lang="en">
    <head>
        ...
        <title>Cluster Head - Bahria University</title>
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="clusterhead.php">Bahria University</a>
            <!-- Sidebar Toggle-->
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="clusterhead.php">
                                <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                                Dashboard
                            </a>
                            <!---<div class="sb-sidenav-menu-heading">Interface</div>--->
                            <a class="nav-link collapsed" href="personalinfoclus.php">
        ...
        <script type="text/javascript" src="assets/demo/chart-area-demo.js"></script>
        <script type="text/javascript" src="assets/demo/chart-bar-demo.js"></script>
