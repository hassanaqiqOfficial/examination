<?php
    ...
    if($_POST) {
        ...
        if(isset($_POST['paperID']) && isset($_POST['paperID']) != ""){
            ...
            $sqlPaper = "UPDATE `papers` SET `paperType`= 1,
            ...
            VALUES (1,'".$data['courseInstructor']."','".$data['session']."','".$data['programSemester']."','".$data['courseName']."','".$data['courseCode']."','".date('y-m-d h:i:s',strtotime($data['date']))."','0','".date('y-m-d h:i:s')."')";
        ...
        if(isset($data['questions'])){
            ...
            $questionsHtml .='<tr class="Question">
                                ...
                                <td width="25%">'.$question['questionMarks'].'</td>
                            </tr>';
                ...
                $questionsHtml .='<tr class="subQuestion" style="margin-left:20px !important;">
                                    <td width="15%">'.numberToRomanRepresentation($is).')'.'</td>
                                    <td width="60%">'.$subQuestion['subQuestion'].'</td>
                                    <td width="25%">'.$subQuestion['subQuestionMarks'].'</td>
                                </tr>';
                     $is++;
                    }
                }
                    ...
                    <div class="info">
                        <table style="width:100%">
                            ...
                            <tr>
                                ...
                                <td>Max Marks: 50 | Generator Code : '.$paperID.' </td>
                            </tr>
                            <tr>
...
<html lang="en">
    <head>
        ...
        <title>Finals - Bahria University</title>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light">Format Final Paper</h3></div>
                                    <div class="card-body">

                                        <form class="form formate-Term-paper" method="POST" action="" id="format-paper">
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    <div class="form-floating">
                                                        ...
                                                        <input type="hidden" name="paperType" value="1" id="hiddenInputField">
